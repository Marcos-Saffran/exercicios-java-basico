public class PetMachine {
    ...
    public void takeAShower(){
        ...
        if (this.water <= 0){
            System.out.println("Não tem água suficiente para dar banho no pet, abasteça a máquina.");
            return;
        }

        if (this.shampoo <= 0){
            System.out.println("Não tem shampoo suficiente para dar banho no pet, abasteça a máquina.");
            return;
        }
